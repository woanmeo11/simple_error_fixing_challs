...
int main(int argc, char* argv[])
{
    try
    {
        ...
        string str_plaintext = "RSA Encryption Schemes";

        static const int SECRET_SIZE = str_plaintext.length();
        SecByteBlock plaintext((const byte*)str_plaintext.data(), SECRET_SIZE);
        //memset( plaintext, 'A', SECRET_SIZE );

        cout << "Plain text: " << plaintext.data() << endl;
        ...
        cout << "Recovered plain text: " << recovered.data() << endl;
    }
